...
const TrainerRegistrationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Form validation
    if (!trainer.designation || !trainer.fieldOfExpertise || !trainer.email || !trainer.password || !trainer.role || !trainer.fullName || !trainer.address || !trainer.profilePic) {
    ...
    try {
      ...
      formData.append('role', trainer.role);
      formData.append('fullName', trainer.fullName);
      formData.append('address', trainer.address);
      formData.append('profilePic', trainer.profilePic);

      await axios.post('http://localhost:8080/trainer/register', formData);
