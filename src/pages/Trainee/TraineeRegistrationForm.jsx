...
const TraineeRegistrationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Form validation
    if (!trainee.institute || !trainee.cgpa || !trainee.email || !trainee.password || !trainee.fullName || !trainee.address || !trainee.profilePic) {
    ...
    try {
      ...
      formData.append('profilePic', trainee.profilePic);

      await axios.post('http://localhost:8080/trainee/register', formData);
